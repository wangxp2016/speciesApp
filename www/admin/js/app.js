...
app.config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('species', {
            ...
            views: {
                'view': {
                    ...
                    templateUrl: 'tpl/speciesManage/species.html'
                }
            }
        })
        // 物种添加
        .state('species-add', {
            ...
            views: {
                'view': {
                    controller: 'speciesAddCtrl',
                    templateUrl: 'tpl/speciesManage/speciesAdd.html'
                }
            }
        })
        // 物种编辑
        .state('species-edit', {
            ...
            views: {
                'view': {
                    controller: 'speciesEditCtrl',
                    templateUrl: 'tpl/speciesManage/speciesEdit.html'
                }
            }
        })
        // 链接管理
